...
<html lang="en">
  ...
  <table  >
    ...
    <tr >
           ...
           <legend style="color:orange">Case Title </legend>      
      
    </tr>
    <tr >
     <li style="color:orange">Description</li>
      <div class="text" style="margin-left:5% ;">My name is Sarah , I am testing this div for limited space  what if it was a bit longer what if it was a bit samller what if what if what if what if what if what if what if what if what if what if what if
      </div>
    </tr>
    <img src="../Needed Files/logo_comp.png" style="position:relative ; left:40%;">
    <tr >
     <li style="color:orange">Location</li>
    ...
    <tr >
      ...
      <div class="text" style="margin-left:5% ;">Status
      </div>
      
    </tr>
     <tr >
      <li style="color:orange">Applicants Number</li>
      <div class="text" style="margin-left:5% ;"><a>42</a>
      </div>
      <br>
    <th >
