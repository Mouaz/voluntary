...
include "../service/models/ngo_reps.php";
 ...
 if(empty($_POST) === false){
					...
					}else*/if(ngo_rep_name_exists($user_name) === false){
					echo '<div class="alert alert-error">
						<a class="close"></a>
						User name does not exist.
					  </div>';
					}else{
					 $login = ngo_rep_login($user_name,$password);
					 //echo $password;
					 //echo $login;
					 if($login === false){
					 echo '<div class="alert alert-error">
...
=======
						echo "<script>window.top.location='../ShowCases/'</script>";
>>>>>>> c8bbfdd3c4ed5649e310332df8a52b5b715b8d1c
...
?>
			...
			<div>
				...
				<a href="#">Request recovering password?</a>
				<!--<a href="#">Register</a>-->
			</div>
		</form><!-- form 
		<div class="button">
